...
var GenItem = function (genlist, gen) {
...
RRuleSet.prototype = {
    ...
    */
    ...
    _genitem: function (list, gen) {
        new GenItem(list, gen);
    },
...
RRuleStr.prototype = {
    ...
    _parseRfcRRule: function (line, options) {
        ...
        rrkwargs.dtstart = options.dtstart;
