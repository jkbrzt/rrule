...
;(function (root, factory) {
  ...
  var dateutil = {
    ...
    isLeapYear: function (year) {
      if (year instanceof dateutil.Date) year = year.getFullYear()
    ...
    combine: function (date, time) {
      ...
      return (date instanceof Date || !time.getTimezone())
        ...
        : new dateutil.Date(
          date.getFullYear(), date.getMonth(), date.getDate(),
          time.getHours(), time.getMinutes(), time.getSeconds(),
          time.getMilliseconds(), time.getTimezone()
        )
    },

    clone: function (date) {
      var dolly = new Date(date.valueOf())
      return dolly
    },
    ...
    untilStringToDate: function (until) {
      ...
      return new dateutil.Date(Date.UTC(
        bits[1],
        bits[2] - 1,
        bits[3],
        bits[5] || 0,
    ...
    */
    ...
    _cacheGet: function (what, args) {
      ...
      return cached instanceof Array
        ...
        : (cached instanceof dateutil.Date ? dateutil.clone(cached) : cached)
    },
    ...
    if (year !== this.lastyear) {
      ...
      if (!plb(rr.options.byweekno)) {
        ...
        if (no1wkst) {
          ...
          var lnumweeks
          if (!contains(rr.options.byweekno, -1)) {
            var lyearweekday = dateutil.getWeekday(new dateutil.Date(year - 1, 0, 1))
    ...
    init: function (method, args) {
      ...
      if (method === 'between') {
        this.maxDate = args.inc
          ? args.before : new dateutil.Date(args.before.getTime() - 1)
        this.minDate = args.inc
          ? args.after : new dateutil.Date(args.after.getTime() + 1)
