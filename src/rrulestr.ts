...
class RRuleStr {
  _handle_DTSTART: (rrkwargs: any, name: any, value: any, options: any) => void;
  _handle_BYDAY: (
    rrkwargs: { [x: string]: Weekday[] },
    name: any,
    value: { split: (arg0: string) => void },
    options: any
  ) => void;
  _handle_INTERVAL: (
    rrkwargs: { [x: string]: number },
    name: { toLowerCase: () => string | number },
    value: string
  ) => void;
  _handle_COUNT: (
    rrkwargs: { [x: string]: number },
  ...
  _handle_int_list(
    ...
    name: { toLowerCase: () => string | number },
    value: {
      split: (arg0: string) => { map: (arg0: (x: any) => number) => void };
    }
  ) {
    // eslint-disable-line
  ...
  _handle_FREQ(rrkwargs, _: any, value: string | number, __: any) {
    // eslint-disable-line
    rrkwargs["freq"] = RRuleStr._freq_map[value];
  }

  _handle_UNTIL(rrkwargs: { [x: string]: Date }, name, value: string, options) {
    // eslint-disable-line
    try {
  ...
  _handle_WKST(rrkwargs, name: any, value: string | number, options: any) {
    // eslint-disable-line
  ...
  _parseRfcRRule(
    line: any,
    options:
      | { cache: any; dtstart: any; ignoretz: any; tzinfos: any }
      | { dtstart: any; ignoretz: any; tzinfos: any; cache?: undefined }
  ) {
    options = options || {};
